...
public class TestStartDecryption {
    ...
    public static void main(String[] args) throws IOException, GeneralSecurityException, Exception{
        TestStartDecryption startEnc = new TestStartDecryption();
        ...
        new TestDecryptKey(startEnc.getPrivate("KeyPair/privateKey_Bob", "RSA"),
        ...
        new TestDecryptData(encryptedFileReceived, decryptedFile, 
