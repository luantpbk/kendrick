...
import com.smartcard.security.digest.crypto.Base64;
import com.smartcard.security.digest.crypto.Hex;
import com.smartcard.security.digest.crypto.Utf8;
...
public class MessageDigestPasswordEncoder extends BaseDigestPasswordEncoder {
	 private final String algorithm;
	    ...
	    public void setIterations(int iterations) {
	        Assert.assertEquals(iterations > 0, true);
