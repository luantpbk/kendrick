...
public class TestStartEncryption {
    ...
    public static void main(String[] args) 
        ...
        TestStartEncryption startEnc = new TestStartEncryption();

        File originalKeyFile = new File("OneKey/secretKey");
        File encryptedKeyFile = new File("EncryptedFiles/encryptedSecretKey");
        new TestEncryptKey(startEnc.getPublic("KeyPair/publicKey_Bob", "RSA"), 
        ...
        new TestEncryptData(originalFile, encryptedFile, 
