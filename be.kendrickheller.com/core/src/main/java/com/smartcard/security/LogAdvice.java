...
import com.smartcard.annotation.interceptor.Logged;
...
public class LogAdvice implements Serializable{
	public static final Logger logger = Logger.getLogger(LogAdvice.class.getCanonicalName());
